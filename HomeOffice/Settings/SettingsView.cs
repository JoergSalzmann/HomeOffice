...
namespace HomeOffice
{
    public partial class SettingsView : Form
    {
        ...
        private void SettingsView_Load(object sender, EventArgs e)
        {
            ...
            nudServerPort.DataBindings.Add(nameof(NumericUpDown.Value), model, nameof(SettingsModel.ServerPort), false, DataSourceUpdateMode.OnPropertyChanged);
            ...
            nudDelayConnect.DataBindings.Add(nameof(NumericUpDown.Value), model, nameof(SettingsModel.DelayBeforeRdpConnect), false, DataSourceUpdateMode.OnPropertyChanged);
